...
function main() {
  ...
  // get the storage locations of u_MvpMatrix
  var u_MvpMatrix = gl.getUniformLocation(gl.program, 'u_MvpMatrix');

  if (!u_MvpMatrix) { 
    console.log('Failed to get the storage location of u_ModelMatrix, u_ViewMatrix and/or u_ProjMatrix');
    return;
  }
  ...
  mvpMatrix.set(projMatrix).multiply(viewMatrix).multiply(modelMatrix);
  // Modify only the model view projection matrix
  gl.uniformMatrix4fv(u_MvpMatrix, false, mvpMatrix.elements);
